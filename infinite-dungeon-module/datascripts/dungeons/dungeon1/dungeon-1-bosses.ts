...
dungeonBoss3.InlineScripts.OnJustEnteredCombat((creature, target) => {
    ...
    creature.AddNamedTimer("combatLoop", 5000, TimerLoops.INDEFINITE, (owner, timer) => {
        ...
        let spells: TSArray<uint32> = <TSArray<uint32>>[
            GetID("Spell", 'infinite-dungeon-mod', "boss3acidwretch1-spell"),
            GetID("Spell", 'infinite-dungeon-mod', "boss3venompool1-spell"),
            GetID("Spell", 'infinite-dungeon-mod', "boss3meltarmor1-spell"),
            GetID("Spell", 'infinite-dungeon-mod', "boss3rumble1-spell"),
            GetID("Spell", 'infinite-dungeon-mod', "boss3acridity1-spell"),
        ];
        let spellMax = 0;
