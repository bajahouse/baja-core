...
export const WARRIOR_SPELL_IDS = {
  ALLIANCE: {},
  HORDE: {},
  ALL: {
...
export const PALADIN_SPELL_IDS = {
  ALLIANCE: {
...
export const DEATH_KNIGHT_SPELL_IDS = {
  ALLIANCE: {},
  HORDE: {},
  ALL: {
    ...
    DK_DEATH_COIL: [47541, 49892, 49893, 49894, 49895],
    DEATH_GATE: [50977],
    DEATHCHILL: [49796],
...
export const WARLOCK_SPELL_IDS = {
  ALLIANCE: {},
  HORDE: {},
  ALL: {
    ATROCITY: [47206],
...
export const SPELL_ID_MAP: { [key: string]: any } = {
  WARRIOR: WARRIOR_SPELL_IDS,
  PALADIN: PALADIN_SPELL_IDS,
  HUNTER: HUNTER_SPELL_IDS,
  ROGUE: ROGUE_SPELL_IDS,
  PRIEST: PRIEST_SPELL_IDS,
  DEATH_KNIGHT: DEATH_KNIGHT_SPELL_IDS,
  SHAMAN: SHAMAN_SPELL_IDS,
  MAGE: MAGE_SPELL_IDS,
  ...
  Object.keys(factions).forEach(factionName => {
    ...
    Object.keys(spells).forEach(spellName => {
      ...
      SPELLS.push({
        ...
        id: spellName,
        cls: className,
        icon: std.Spells.load(list[0]).Icon.getPath(),
        faction: factionName,
        first: list[0],
